...
void * thread1(){
    ...
    printf("\n--------------------------------\n");
    printf("Thread 1 is waiting for 8 seconds\n");
    // wait(8);
    delay(8);
...
void * thread2(){
    ...
    printf("\n--------------------------------\n");
    printf("Thread 2 is waiting for 5 seconds\n");
    // wait(5);
    delay(5);
...
void * thread3(){
    ...
    printf("\n--------------------------------\n");
    printf("Thread 3 is waiting for 3 seconds\n");
    // wait(3);
    delay(3);
...
void * thread4(){
    ...
    printf("\n--------------------------------\n");
    printf("Thread 4 is waiting for 6 seconds\n");
    // wait(6);
    delay(6);
...
int main(){
    ...
    sched_setscheduler((pid_t) pthread_self(), SCHED_FIFO, &param_main);
